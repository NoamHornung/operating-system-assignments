...
void uthread_c_start_func(void){
  //printf("uthread_c_start_func\n");
  for(int i=0; i<10; i++){
    sleep(10); // simulate work
  }
  x = uthread_get_priority();
...
void ulttest()
{
  ...
  uthread_create(uthread_b_start_func, HIGH);
  uthread_create(uthread_c_start_func, MEDIUM);
  uthread_start_all();
...
//   for(int i=0; i<10; i++){
//     printf("thread_a_start_func\n");
//     sleep(10); // simulate work
//     x = uthread_get_priority();
//     if(x != LOW){
//       printf("uthread_get_priority failed 1\n");
//       exit(1);
//     }
//   }
//   uthread_exit();
//   printf("uthread_exit failed 1\n");
//   exit(1);
// }

// void thread_b_start_func(void){
//   for(int i=0; i<10; i++){
//     printf("thread_b_start_func\n");
//     sleep(10); // simulate work
//     x = uthread_get_priority();
//     if(x != MEDIUM){
//       printf("uthread_get_priority failed 2\n");
//       exit(1);
//     }
//   }
//   uthread_exit();
//   printf("uthread_exit failed 2\n");
//   exit(1);
// }
...
//   uthread_start_all();
//   if(x != LOW){
//     printf("uthread_get_priority failed 3\n");
//     exit(1);
//   }
//   exit(0);
// }
